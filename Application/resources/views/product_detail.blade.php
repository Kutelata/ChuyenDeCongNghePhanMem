            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                    <div class="ps-product__thumbnail">
                        <div class="ps-product__preview">
                            ...
                            <a class="popup-youtube ps-product__video"
                               href="https://www.youtube.com/watch?v=0O2aH4XLbto"><img src="images/shoe-detail/1.jpg"
                    ...
                    <div class="ps-product__info">
                        ...
                        <p class="ps-product__category"><a href="#"> Men shoes</a>,<a href="#"> Nike</a>,<a href="#">
                                Jordan</a></p>
                        <h3 class="ps-product__price">£ 115
                            <del>£ 330</del>
                        </h3>
                    ...
                    <div class="tab-content mb-60">
                        ...
                        <div class="tab-pane" role="tabpanel" id="tab_02">
                            ...
                            <form class="ps-product__review" action="https://nouthemes.net/html/trueshoes/_action"
                                  method="post">
                        ...
                        <div class="tab-pane" role="tabpanel" id="tab_03">
                            ...
                            <form class="ps-product__tags" action="https://nouthemes.net/html/trueshoes/_action"
                                  method="post">
                                <div class="form-group">
                                    <input class="form-control" type="text" placeholder="">
