...
<div class="ps-products-wrap pt-80 pb-80">
    <div class="ps-products" data-mh="product-listing">
        <div class="ps-section--offer mb-40">
            <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{asset('resources/images/banner/banner-1.jpg')}}"
                        alt=""></a></div>
            <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{asset('resources/images/banner/banner-2.jpg')}}"
                        alt=""></a></div>
        </div>
                    ...
                    <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail">
                            ...
                            <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                                ...
                                src="{{asset('resources/images/shoe/')}}/{{$p->image}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                        </div>
