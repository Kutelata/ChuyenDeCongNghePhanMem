                    ...
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            ...
                            <a class="ps-shoe__favorite" href="#">
                                <i class="ps-icon-heart"></i></a><img src="{{asset('resources/images/shoe/air-force-1-07/air-force-1-07.jpg')}}"
                                alt="">
                ...
                <div class="ps-shoes--carousel">
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            <div class="ps-badge"><span>New</span></div>
                            <a class="ps-shoe__favorite" href="#">
                                <i class="ps-icon-heart"></i></a><img src="{{asset('resources/images/shoe/co_thap_forum/co_thap_forum.jpg')}}"
                                alt="">
                            <a class="ps-shoe__overlay" href="product-detail.html">
                            </a>
                        </div>
